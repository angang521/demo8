            ...
            <div class="page-body">
                <div class="row">
                        ...
                        <div class="widget">
                                    ...
                                    <form id="query-form" method="post" class="form-horizontal bv-form" >
                                            ...
                                            <tr>
                                                <td class="form-group col-md-4">
                                                    ...
                                                    <div class="form-group col-lg-7">
                                                        <input type="text" class="form-control input-sm" name="bannerName" data-bv-checkUnsafeLetters="true" />
                                        ...
                                        <div class="form-group">
                                            <div class="col-lg-12 col-lg-offset-5">
                                                <button type="button" class="btn default" onclick="$.bboss.form.resetForm('#query-form')">重置</button>&nbsp;&nbsp;&nbsp;&nbsp;
                                                <button th:if="${session.button_menu['/mbp/service/appBannerService/selectByPage.do']}" type="button" class="btn btn-warning" onclick="$.bboss.form.doSearch('#query-form',initTableDate);">查询</button>
                                            </div>
                                        </div>
                                    </form>
                                </div>
                            ...
                            <div class="widget-header ">
                                ...
                                <div class="widget-buttons">
                                    <button th:if="${session.button_menu['/mbp/service/appBannerService/add.do']}" class="btn btn-success" data-toggle="modal" onclick="showModifyDiv('add');" >
                                        <i class="fa fa-pencil"></i> 新增
                                    </button>
                                    <button th:if="${session.button_menu['/mbp/service/appBannerService/modify.do']}" class="btn btn-yellow disabled" id="update_btn" onclick="showModifyDiv('update');">
                                        <i class="fa fa-pencil"></i> 修改
                                    </button>
                                    <button th:if="${session.button_menu['/mbp/service/appBannerService/delete.do']}" class="btn btn-danger disabled" id="delete_btn" onclick="$.bboss.form.doDelete(_tableDataList,doDeleteCallBack);">
                    ...
                    <div class="col-xs-12 col-md-12" id="Project_Add_Form" modifyFlag="" style="display: none;">
                        <div class="widget radius-bordered">
                            <div class="widget-header">
                                <span class="widget-caption"><i class="fa fa-cogs"></i>&nbsp;<span id="modifyTitle">新增</span>banner页</span>
                            </div>
                            <div class="widget-body">
                                <form id="uploadForm-auto" method="post" class="form-horizontal bv-form" >
                                    <table class="table table-striped table-bordered table-hover dataTable" aria-describedby="datatable_orders_info" style="table-layout: fixed;">
                                        <tr >
                                            <td colspan="6">
                                        ...
                                        <tr>
                                            <td class="form-group col-lg-2 " ><label class="control-label">上传图片：</label></td>
                                            <td class="form-group col-lg-2 bbossfile" colspan="5">
                                                <input type="text" id="filePath-auto" name="filePath" data-bv-fileType="true" data-bv-fileType-fileType="image/png,image/jpg,image/jpeg,image/gif" data-bv-fileMaxSize="true" data-bv-fileMaxSize-maxMB="1" bboss-file-photoTitle="图片"  />
                                            </td>
                                        </tr>
                                    ...
                                    <div class="form-group">
                                        <div class="col-lg-offset-5 col-lg-8">
                                            <span class="btn loading upload_loading" style="padding:2px 0 2px 22px;;font-size:13px;display:none;" id="upload_loading-auto" >文件正在上传中...</span>
                                        </div>
                                    </div>
                                ...
                                <form id="uploadForm-auto-page2" method="post" class="form-horizontal bv-form" >
                                    <table class="table table-striped table-bordered table-hover dataTable" aria-describedby="datatable_orders_info" style="table-layout: fixed;">
                                        ...
                                        <tr>
                                            <td class="form-group col-lg-2 " ><label class="control-label">上传图片：</label></td>
                                            <td class="form-group col-lg-2 bbossfile" colspan="5">
                                                <input type="text" id="filePath-auto-page2" name="filePath" data-bv-fileType="true" data-bv-fileType-fileType="image/png,image/jpg,image/jpeg,image/gif" data-bv-fileMaxSize="true" data-bv-fileMaxSize-maxMB="1" bboss-file-photoTitle="图片"  />
                                            </td>
                                        </tr>
                            ...
                            <div class="widget-body">
                                <form id="modifyForm" method="post" class="form-horizontal bv-form" >
                                    ...
                                    <div class="form-group">
                                        <label class="col-lg-2 control-label"><font color="red">*</font>banner名称:</label>
                                        <div class="col-lg-8">
                                            <input type="text" class="form-control input-sm" name="bannerName" placeholder="请输入名称" data-bv-notempty="true"  data-bv-checkUnsafeLetters="true" />
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <label class="col-lg-2 control-label"><font color="red">*</font>标题:</label>
                                        <div class="col-lg-8">
                                            <input type="text" class="form-control input-sm" name="title" placeholder="请输入名称" data-bv-notempty="true"  data-bv-checkUnsafeLetters="true" />
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <label class="col-lg-2 control-label">内容:</label>
                                        <div class="col-lg-8">
                                            <input type="text" class="form-control input-sm" name="content" placeholder="请输入内容" data-bv-notempty="false"  data-bv-checkUnsafeLetters="false" />
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <label class="col-lg-2 control-label">底部tab默认内容:</label>
                                        <div class="col-lg-8">
                                            <input type="text" class="form-control input-sm" name="contentSub" placeholder="请输入默认内容" data-bv-notempty="false"  data-bv-checkUnsafeLetters="false" />
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <label class="col-lg-2 control-label">URL:</label>
                                        <div class="col-lg-8">
                                            <input type="text" class="form-control input-sm" name="url" id="url" placeholder="请输入URL"  data-bv-notempty="false" data-bv-checkUnsafeLetters="true"/>
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-lg-8">
                                            <input type="text" class="form-control input-sm" name="provinceId" id="provinceId" data-bv-notempty="false"  data-bv-checkUnsafeLetters="false"/>
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-lg-8">
                                            <input type="text" class="form-control input-sm" name="fontColor" id="fontColor" placeholder="请输入字体颜色"  data-bv-notempty="false" data-bv-checkUnsafeLetters="false"/>
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <label class="col-lg-2 control-label">字体默认颜色:</label>
                                        <div class="col-lg-8">
                                            <input type="text" class="form-control input-sm" name="fontColorSub" id="fontColorSub" placeholder="请输入字体默认颜色"  data-bv-notempty="false" data-bv-checkUnsafeLetters="false"/>
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-lg-8">
                                            <input type="text" class="form-control datetime input-sm" name="beginDateTemp" id="beginDateTemp" data-bv-checkUnsafeLetters="false"/>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-lg-8">
                                            <input type="text" class="form-control datetime input-sm" name="endDateTemp" id="endDateTemp" data-bv-checkUnsafeLetters="false"/>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-lg-8">
                                            <input type="text" class="form-control input-sm" name="showSeq" id="showSeq" placeholder="请输入展示顺序"  data-bv-notempty="false" data-bv-checkUnsafeLetters="false"/>
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <div class="col-lg-offset-5 col-lg-8">
                                            <input id="cancel" class="btn btn-default" type="button" value="取消" onclick="doAddRoll();"/>
                                            <input id="save" class="btn btn-palegreen" type="button" value="增加" onclick="doModify(this);"/>
                                        </div>
                                    </div>
                                </form>
                            </div>
...
<script th:inline="javascript">
    ...
    var initTableDate=function (parms) {
        ...
        $.bboss.remote.ajax(WWWROOT + "/mbp/service/appBannerService/selectByPage.do",parms,'get',function(data){
            ...
            },false,function(){resetControlBtns();});
        });
    };
